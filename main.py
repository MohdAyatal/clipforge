"""
ClipForge — Lightweight backend using ONLY free APIs:
...
# Deno is installed in Dockerfile at this path
...
async def download_video(job_id: str, url: str) -> str:
    ...
    cmd = [
        ...
        "--js-runtimes", f"deno:{DENO_PATH}",  # Use deno installed in Dockerfile
        "--output", out,
        "--no-playlist",
        url,
    ]
